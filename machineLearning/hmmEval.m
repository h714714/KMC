function [optPath, stateProb, hmmTable]=hmmEval(inputData, hmmPrm, showPlot)
% hmmEval: HMM evaluation
%
%	Usage:
%		optPath=hmmEval(inputData, hmmPrm)
%		optPath=hmmEval(inputData, hmmPrm, showPlot)
...
%		optPath=hmmEval(inputData, hmmPrm, showPlot) plot the optimum path if showPlot=1.
